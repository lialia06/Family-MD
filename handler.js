...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = namabot + ' ву 𓂀 𝒱𝒾𝓉𝒶𝓉𝒶𝒞𝓁𝓊𝒷 𓂀'
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? 'selamat datang' : 'sampai jumpa', action === 'add' ? '.intro' : '𓂀 𝒱𝒾𝓉𝒶𝓉𝒶𝒞𝓁𝓊𝒷 𓂀')
                        }
                    }
                }
                break
